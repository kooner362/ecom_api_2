...
import { ShoppingCart, Search, User, Menu, X, ChevronDown, Flame } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center h-16 gap-4">
          ...
          <Link to="/" className="flex items-center gap-2 shrink-0">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center overflow-hidden bg-white/10" style={{ border: '1px solid rgba(255,255,255,0.2)' }}>
            ...
            <span className="font-display font-700 text-white text-xl tracking-tight">
              {storeName}
              {storeHost ? <span style={{ color: state.theme.primaryColor }}></span> : null}
            </span>
          </Link>
