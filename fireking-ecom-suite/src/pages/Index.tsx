    ...
    hero: (
      <section key="hero" className="relative min-h-[70vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImage} alt="Fireworks" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-20">
          <div className="max-w-2xl animate-fade-in">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="/category/aerial-shells" className="inline-flex items-center gap-2 px-8 py-3.5 rounded-lg text-base font-semibold text-white border border-white/30 hover:bg-white/10 transition-colors backdrop-blur-sm">
                Browse Categories
              </Link>
            </div>
          </div>
